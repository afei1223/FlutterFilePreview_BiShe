...
public class YiyunFilePreview {
    ...
    public static boolean CanOpenFile(String path,Activity mActivity){
        ...
        if(qwe.length>1){
            ...
            Toast.makeText(mActivity,"后缀错误",Toast.LENGTH_SHORT).show();
            return false;
        }

    }

    public static boolean IfFileExists(String path, Activity mActivity) {
        try{
